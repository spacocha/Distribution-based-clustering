...
#   Edited on 08/16/12 
#
$programname="distribution_clustering.pl";
...
Options:
    ...
    -JS JS_CUTOFF             Use the Jensen-Shannon diistance to determine whether to merge values (default=off), especially when -abund 0. (optional)
                              Good JS_CUTOFF value around 0.02 (best to use when abundance thresh = 0). Will be applied after failing chi-sq test cut-off. (optional)
